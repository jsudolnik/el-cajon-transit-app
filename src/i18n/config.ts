...
planTrip: {
title: 'Plan Your Trip',description: 'Plan your journey using public transit'
},
compareRides: {
...
planTrip: {title: 'خطط لرحلتك',
  ...
  pages: {
  nearbyStops: {
  title: 'Paradas de Tránsito Cercanas',description: 'Encuentra paradas de autobús y tren cerca de ti',
  away: 'lejos'
  },
  planTrip: {
  ...
  pages: {
  nearbyStops: {title: 'Các Điểm Dừng Gần Đây',
    ...
    subtitle: 'Ang iyong gabay sa pampublikong transportasyon sa El Cajon'
      ...
      welcome: {
      title: '埃尔卡洪交通指南',subtitle: '您在埃尔卡洪的公共交通指南'
    },
    pages: {
    nearbyStops: {
    title: '附近交通站点',
